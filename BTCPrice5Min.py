...
conn.request("GET", "/api/v3/brokerage/market/products/BTC-USD/candles?granularity=FIVE_MINUTE&limit=350", '', {'Content-Type': 'application/json'})
...
if 'candles' in response_json:
    ...
    with open("BTCPrettyPrice5Min.txt", "a") as f:
