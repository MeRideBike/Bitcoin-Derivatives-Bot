...
conn.request("GET", "/api/v3/brokerage/market/products/BTC-USD/candles?granularity=ONE_HOUR&limit=350", '', {'Content-Type': 'application/json'})
...
if 'candles' in response_json:
    ...
    with open("BTCPrettyPrice1Hour.txt", "a") as f:
